...
const MehndiBooking = () => {
  ...
  return (
    <div className="bg-[#fcfaf7] min-h-screen font-body pb-64 lg:pb-20">
      ...
      <div className="fixed bottom-6 left-4 right-4 p-2 bg-white/90 backdrop-blur-2xl border border-white/50 flex flex-row items-center justify-between gap-3 lg:hidden z-50 shadow-2xl rounded-full">
           <a 
            ...
            className="flex-1 bg-[#25D366] text-white py-3 rounded-full font-bold text-sm shadow-md flex items-center justify-center gap-2 active:scale-95 transition-transform"
          >
          ...
          <button 
            ...
            className="flex-1 bg-stone-900 text-white border border-stone-900 px-4 py-3 rounded-full font-bold text-sm hover:bg-stone-800 transition-all flex items-center justify-center gap-2 shadow-xl active:scale-95"
          >
