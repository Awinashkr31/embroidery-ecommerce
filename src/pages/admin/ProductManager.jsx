...
const ProductManager = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const clothingInfo = {
            ...
            colors: colors,
            sizes: formData.availableSizes.reduce((acc, size) => ({ ...acc, [size]: formData.stockQuantity }), {}), // Use global stock as default for sizes
        ...
        <div className="font-body space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div className="flex gap-3">
                    ...
                    <button onClick={() => handleOpenModal(null, 'standard')} className="hidden md:flex px-5 py-2.5 bg-rose-900 text-white rounded-xl font-bold items-center gap-2 hover:bg-rose-800 transition-colors shadow-lg shadow-rose-900/20">
            ...
            <div className="bg-white rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border-0 overflow-hidden">
                {/* Search Bar */}
                <div className="p-4 border-b border-stone-50 flex flex-col sm:flex-row gap-4">
            ...
            {/* Mobile FAB */}
            <button
                onClick={() => handleOpenModal(null, 'standard')}
                className="md:hidden fixed bottom-6 right-6 z-40 w-14 h-14 bg-rose-900 text-white rounded-full flex items-center justify-center shadow-[0_8px_30px_-4px_rgba(159,18,57,0.4)] hover:bg-rose-800 transition-all active:scale-95"
            >
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center sm:p-4">
                    ...
                    <div className="relative bg-white sm:rounded-2xl shadow-2xl w-full max-w-5xl h-[100dvh] sm:h-[85vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
                        {/* Modal Header */}
                        <div className="px-4 py-3 sm:px-8 sm:py-4 border-b border-stone-100 flex justify-between items-center bg-white z-[70] shrink-0 sticky top-0">
                            <div className="min-w-0 flex-1 mr-4">
                                <h2 className="text-base font-heading font-bold text-stone-900 truncate">
                                    {editingId ? '✏️ Edit Product' : '➕ New Product'}
                                </h2>
                                {formError && (
                                    <p className="text-xs text-red-600 font-medium mt-0.5 flex items-center gap-1">
                                        <AlertCircle className="w-3 h-3 shrink-0" /> <span className="line-clamp-1">{formError}</span>
                                    </p>
                                )}
                            </div>
                            <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
                                <button
                                    ...
                                    className="p-2 sm:px-4 sm:py-2 bg-gradient-to-r from-violet-600 to-indigo-600 text-white rounded-xl hover:from-violet-500 hover:to-indigo-500 transition-all flex items-center justify-center shadow-md shadow-violet-600/20 disabled:opacity-60 disabled:cursor-wait"
                                    title="AI Auto Fill"
                                >
                                    {isAutoFilling ? (
                                    ...
                                    <span className="hidden sm:inline ml-2">{isAutoFilling ? 'Generating...' : 'AI Auto Fill'}</span>
                                </button>
                                <button
                                    type="button"
                                    onClick={handleSubmit}
                                    className="px-4 py-2 bg-rose-900 text-white text-sm font-bold rounded-xl hover:bg-rose-800 transition-colors flex items-center gap-2 shadow-sm"
                                >
                                    <Save className="w-4 h-4" />
                                    <span className="hidden sm:inline">{editingId ? 'Save Changes' : 'Publish'}</span>
                        ...
                        {/* Tabs Header */}
                        <div className="flex px-4 sm:px-8 border-b border-stone-100 bg-stone-50/50 gap-4 sm:gap-6 overflow-x-auto no-scrollbar shrink-0">
                            {[
                        ...
                        {/* Modal Body */}
                        <div className="flex-1 overflow-y-auto p-4 sm:p-8 bg-[#fbfbfb]">
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="bg-stone-50 rounded-2xl p-6 border border-stone-100 space-y-6">
                                            ...
                                            {/* Editor Form */}
                                            <div className="bg-white p-4 rounded-xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border-0">
