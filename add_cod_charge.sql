-- Add cod_charge to orders table
ALTER TABLE "public"."orders" ADD COLUMN IF NOT EXISTS "cod_charge" numeric(10,2) DEFAULT 0;

-- Update the place_order function to handle cod_charge
